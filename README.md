...
| [capnp-byte-stream](/capnp-byte-stream) | Adapters between the Cap'n Proto `ByteStream` RPC protocol and async byte streams. | [![crates.io](https://img.shields.io/crates/v/capnp-byte-stream.svg)](https://crates.io/crates/capnp-byte-stream) |
| [capnp-http](/capnp-http) | Framework-agnostic bridge between [`http`](https://crates.io/crates/http) services and the Cap'n Proto `http-over-capnp` protocol, with optional [`hyper`](https://crates.io/crates/hyper) and [`tower`](https://crates.io/crates/tower)/[`axum`](https://crates.io/crates/axum) adapters. | [![crates.io](https://img.shields.io/crates/v/capnp-http.svg)](https://crates.io/crates/capnp-http) |
